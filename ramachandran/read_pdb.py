...
def read_protein(pdb_filepath: str) -> Dict[Any, Any]:
        ...
        for line in fp:
            ...
            if line[0:4] == "ATOM":
                ...
                try:
                    ...
                    raise RuntimeError("Residue sequence number has to be integer.")
                ...
                try:
                    ...
                    raise RuntimeError("Atom coordinate has to be a real value.")

                atom_coodinates = (x, y, z)
                ...
                if "residue" not in protein[chain_identifier][residue_sequence_number]:
                    protein[chain_identifier][residue_sequence_number]["residue"] = residue_name
                
                protein[chain_identifier][residue_sequence_number][atom_name] = atom_coodinates
